			...
			public void onClick(View v) {
				Toast.makeText(getApplicationContext(), "stop", Toast.LENGTH_LONG).show();
				 if (null != bluetoothService) {
						bluetoothService.write(StringHexUtils.hexStr2Bytes(StringHexUtils.encode("stop")));  
				 }
			}
		});
...
//					 }
					 if(event.getAction() == MotionEvent.ACTION_DOWN){  
						 ...
						 if (null != bluetoothService) {
								bluetoothService.write(StringHexUtils.hexStr2Bytes(StringHexUtils.encode("font")));  
						 }
					 }
				 }
				return false;
...
//					 }
					 if(event.getAction() == MotionEvent.ACTION_DOWN){  
						 ...
						 if (null != bluetoothService) {
								bluetoothService.write(StringHexUtils.hexStr2Bytes(StringHexUtils.encode("back")));  
						 }
					 }
				 }
				return false;
...
//					 }
					 if(event.getAction() == MotionEvent.ACTION_DOWN){  
						 ...
						 if (null != bluetoothService) {
								bluetoothService.write(StringHexUtils.hexStr2Bytes(StringHexUtils.encode("left")));  
						 }
					 }
				 }
				return false;
...
//					 }
					 if(event.getAction() == MotionEvent.ACTION_DOWN){  
						 ...
						 if (null != bluetoothService) {
								bluetoothService.write(StringHexUtils.hexStr2Bytes(StringHexUtils.encode("right")));  
						 }
					 }
				 }
				return false;
